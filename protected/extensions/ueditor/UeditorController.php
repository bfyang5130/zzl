...
class UeditorController extends CExtController{
    ...
    public function init(){
        ...
        $default = array(
            'imagePathFormat'=>$webroot.'/date/uplaod/project/article/image/{yyyy}{mm}{dd}/{time}{rand:6}',
            'scrawlPathFormat'=>$webroot.'/date/uplaod/project/article/image/{yyyy}{mm}{dd}/{time}{rand:6}',
            'snapscreenPathFormat'=>$webroot.'/date/uplaod/project/article/image/{yyyy}{mm}{dd}/{time}{rand:6}',
            'catcherPathFormat'=>$webroot.'/date/uplaod/project/article/image/{yyyy}{mm}{dd}/{time}{rand:6}',
            'videoPathFormat'=>$webroot.'/date/uplaod/project/article/video/{yyyy}{mm}{dd}/{time}{rand:6}',
            'filePathFormat'=>$webroot.'/date/uplaod/project/article/file/{yyyy}{mm}{dd}/{rand:4}_{filename}',
            'imageManagerListPath'=>$webroot.'/date/uplaod/project/article/image/',
            'fileManagerListPath'=>$webroot.'/date/uplaod/project/article/file/',
        );
