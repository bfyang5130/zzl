...
class BaseTool {
    ...
    //put your code here
    public static function ENPWD($string = "") {
        return md5("rmb" . sha1($string . "zuan"));
    }

    public static function defaultEditer() {
        return "toolbars:[
            ...
            ['justifyleft','justifycenter','justifyright','justifyjustify','|','link','unlink','|','insertimage','map','pagebreak','|','preview','searchreplace','help']
        	]";
    }
    ...
    public static function createFolder($path, $chmod = 777) {
        ...
        return self::create_folders($path);
    }
     ...
     * 创建一个固定的目录
     */
    public static function createABFolder($path, $chmod = 777) {
     ...
     * 邮件激活生成的加密字符串
     */
    public static function getActiveMailCode($username) {
        return md5(md5(sha1("zuanzuanle") . $username) . rand(10000, 99999));
    }
