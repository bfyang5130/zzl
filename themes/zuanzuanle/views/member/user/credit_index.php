...
<ul class="nav nav-tabs" role="tablist">
    <li <?php echo ($_REQUEST['tab'] == '') ? 'class="active"' : ''; ?>><a href="#project_base" role="tab" data-toggle="tab">信誉等级</a></li>
</ul>
                ...
                if ($dataProvider->getData()) {
                    ...
                    <script type="text/javascript">
                        $('#pagination-memerlog').twbsPagination({
                            ...
                            href: '/member/user/credit/<?php echo $dataProvider->getId() ?>_page/{{number}}.html',
                            onPageClick: function(event, page) {
                                window.location.href = '/member/user/credit/<?php echo $dataProvider->getId() ?>_page/' + page + '.html';
                            }
                        });
                        $('a').popover({
                            trigger: 'click'
