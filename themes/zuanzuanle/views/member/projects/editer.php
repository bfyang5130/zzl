                    ...
                    <td class="qys_publish_td_right">
                        <div class="form-group">
                            <div class="col-lg-5">
                                <?php
                                if ($thisproject->type = 3) {
                                    echo $thisproject->account;
                                } else {
                                    echo $form->textField($thisproject, 'account', array('id' => 'publish_account', 'class' => 'form-control'));
                                }
                                ?>
                            </div>
                ...
                <tr>
                    ...
                    if ($thisproject->type = 3) {
                        ...
                        <td class="qys_publish_td_right">
                            <div class="form-group">
                                <div class="col-lg-5">
                                    <?php echo $form->dropDownList($thisproject, 'low_account', Project::getLowAccountLimitValue(), array('class' => 'form-control')); ?>
                                </div>
                                <label class="control-label col-lg-7" style="text-align: left;">需在多少天内完成筹资</label>
                            </div><!-- /.form-group -->
                        </td>
